...
export type GraphCms_AssetGatsbyImageDataArgs = {
	...
	outputPixelDensities?: Maybe<Maybe<Scalars['Float']>[]>;
	breakpoints?: Maybe<Maybe<Scalars['Int']>[]>;
...
export type GraphCms_Recipe = Node & {
	...
	updatedBy?: Maybe<GraphCms_User>;
	publishedBy?: Maybe<GraphCms_User>;
	images: GraphCms_Asset[];
	subrecipes: GraphCms_Recipe[];
	tags: GraphCms_Tag[];
	cuisines: GraphCms_Cuisine[];
...
export type GraphCms_Difficulty = 'Easy' | 'Medium' | 'Hardcore';

export type GraphCms_Tool = 'Mixer' | 'HandBlender';
...
export type GraphCms_Country = 'Germany';
...
export type QueryGraphCmsRecipeArgs = {
	...
	tools?: Maybe<GraphCms_ToolQueryOperatorInput>;
	id?: Maybe<StringQueryOperatorInput>;
	parent?: Maybe<NodeFilterInput>;
	children?: Maybe<NodeFilterListInput>;
	internal?: Maybe<InternalFilterInput>;
...
export type SiteFunctionConnection = {
	...
	min?: Maybe<Scalars['Float']>;
	sum?: Maybe<Scalars['Float']>;
	group: SiteFunctionGroupConnection[];
};
...
export type SiteFunctionSortInput = {
	fields?: Maybe<Maybe<SiteFunctionFieldsEnum>[]>;
	order?: Maybe<Maybe<SortOrderEnum>[]>;
};
...
export type GraphCms_UserKindQueryOperatorInput = {
	...
	in?: Maybe<Maybe<GraphCms_UserKind>[]>;
	nin?: Maybe<Maybe<GraphCms_UserKind>[]>;
};
...
export type GraphCms_TagQueryOperatorInput = {
	...
	in?: Maybe<Maybe<GraphCms_Tag>[]>;
	nin?: Maybe<Maybe<GraphCms_Tag>[]>;
};

export type GraphCms_CuisineQueryOperatorInput = {
	eq?: Maybe<GraphCms_Cuisine>;
	ne?: Maybe<GraphCms_Cuisine>;
	in?: Maybe<Maybe<GraphCms_Cuisine>[]>;
	nin?: Maybe<Maybe<GraphCms_Cuisine>[]>;
};

export type GraphCms_DifficultyQueryOperatorInput = {
	eq?: Maybe<GraphCms_Difficulty>;
	ne?: Maybe<GraphCms_Difficulty>;
	in?: Maybe<Maybe<GraphCms_Difficulty>[]>;
	nin?: Maybe<Maybe<GraphCms_Difficulty>[]>;
};

export type GraphCms_ToolQueryOperatorInput = {
	eq?: Maybe<GraphCms_Tool>;
	ne?: Maybe<GraphCms_Tool>;
	in?: Maybe<Maybe<GraphCms_Tool>[]>;
	nin?: Maybe<Maybe<GraphCms_Tool>[]>;
};
...
export type GraphCms_AssetConnection = {
	...
	min?: Maybe<Scalars['Float']>;
	sum?: Maybe<Scalars['Float']>;
	group: GraphCms_AssetGroupConnection[];
};
...
export type GraphCms_AssetSortInput = {
	fields?: Maybe<Maybe<GraphCms_AssetFieldsEnum>[]>;
	order?: Maybe<Maybe<SortOrderEnum>[]>;
};
...
export type GraphCms_UserConnection = {
	...
	min?: Maybe<Scalars['Float']>;
	sum?: Maybe<Scalars['Float']>;
	group: GraphCms_UserGroupConnection[];
};
...
export type GraphCms_UserSortInput = {
	fields?: Maybe<Maybe<GraphCms_UserFieldsEnum>[]>;
	order?: Maybe<Maybe<SortOrderEnum>[]>;
};

export type GraphCms_RecipeConnection = {
	totalCount: Scalars['Int'];
	edges: GraphCms_RecipeEdge[];
	nodes: GraphCms_Recipe[];
	pageInfo: PageInfo;
	distinct: Scalars['String'][];
	max?: Maybe<Scalars['Float']>;
	min?: Maybe<Scalars['Float']>;
	sum?: Maybe<Scalars['Float']>;
	group: GraphCms_RecipeGroupConnection[];
};
...
export type GraphCms_RecipeSortInput = {
	fields?: Maybe<Maybe<GraphCms_RecipeFieldsEnum>[]>;
	order?: Maybe<Maybe<SortOrderEnum>[]>;
};
...
export type GraphCms_MonthQueryOperatorInput = {
	...
	in?: Maybe<Maybe<GraphCms_Month>[]>;
	nin?: Maybe<Maybe<GraphCms_Month>[]>;
};

export type GraphCms_KindQueryOperatorInput = {
	eq?: Maybe<GraphCms_Kind>;
	ne?: Maybe<GraphCms_Kind>;
	in?: Maybe<Maybe<GraphCms_Kind>[]>;
	nin?: Maybe<Maybe<GraphCms_Kind>[]>;
};

export type GraphCms_IngredientConnection = {
	totalCount: Scalars['Int'];
	edges: GraphCms_IngredientEdge[];
	nodes: GraphCms_Ingredient[];
	pageInfo: PageInfo;
	distinct: Scalars['String'][];
	max?: Maybe<Scalars['Float']>;
	min?: Maybe<Scalars['Float']>;
	sum?: Maybe<Scalars['Float']>;
	group: GraphCms_IngredientGroupConnection[];
};
...
export type GraphCms_IngredientSortInput = {
	fields?: Maybe<Maybe<GraphCms_IngredientFieldsEnum>[]>;
	order?: Maybe<Maybe<SortOrderEnum>[]>;
};
...
export type GraphCms_CountryQueryOperatorInput = {
	...
	in?: Maybe<Maybe<GraphCms_Country>[]>;
	nin?: Maybe<Maybe<GraphCms_Country>[]>;
};

export type GraphCms_ShopTypeQueryOperatorInput = {
	eq?: Maybe<GraphCms_ShopType>;
	ne?: Maybe<GraphCms_ShopType>;
	in?: Maybe<Maybe<GraphCms_ShopType>[]>;
	nin?: Maybe<Maybe<GraphCms_ShopType>[]>;
};

export type GraphCms_ShopConnection = {
	totalCount: Scalars['Int'];
	edges: GraphCms_ShopEdge[];
	nodes: GraphCms_Shop[];
	pageInfo: PageInfo;
	distinct: Scalars['String'][];
	max?: Maybe<Scalars['Float']>;
	min?: Maybe<Scalars['Float']>;
	sum?: Maybe<Scalars['Float']>;
	group: GraphCms_ShopGroupConnection[];
};
...
export type GraphCms_ShopSortInput = {
	fields?: Maybe<Maybe<GraphCms_ShopFieldsEnum>[]>;
	order?: Maybe<Maybe<SortOrderEnum>[]>;
};
...
export type IndexPageQuery = {
	allGraphCmsRecipe: { nodes: Pick<GraphCms_Recipe, 'title' | 'slug'>[] };
};
...
export type AllRecipesQuery = {
	allGraphCmsRecipe: { nodes: Pick<GraphCms_Recipe, 'slug'>[] };
};
