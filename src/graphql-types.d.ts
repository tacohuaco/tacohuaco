...
export type RecipePageQuery = { graphCmsRecipe?: Maybe<(
    ...
    & { flags: Pick<RecipeFlagsJson, 'vegan' | 'vegetarian' | 'gluten' | 'diary' | 'addedSugar'>, images: Array<Pick<GraphCms_Asset, 'url' | 'handle' | 'width' | 'height'>> }
  )> };
