...
export type GraphCms_ToolQueryOperatorInput = {
  ...
  in?: Maybe<Array<Maybe<GraphCms_Tool>>>;
  nin?: Maybe<Array<Maybe<GraphCms_Tool>>>;
};
...
export type RecipePageQuery = { graphCmsRecipe?: Maybe<(
    ...
    & { images: Array<Pick<GraphCms_Asset, 'url' | 'handle' | 'width' | 'height'>> }
  )>, allGraphCmsIngredient: { nodes: Array<Pick<GraphCms_Ingredient, 'name' | 'season' | 'kind' | 'hasDairy' | 'hasGluten' | 'hasNuts' | 'hasSugar'>> } };
